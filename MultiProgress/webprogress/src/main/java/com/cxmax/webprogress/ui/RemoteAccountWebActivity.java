...
import com.cxmax.webprogress.R;
...
public class RemoteAccountWebActivity extends AppCompatActivity {

    private String title;
    private String url;

    public static void start(Context context, String title, String url) {
        Intent intent = new Intent(context, RemoteAccountWebActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        transaction.replace(R.id.web_view_fragment, RemoteAccountWebFragment.newInstance(url)).commit();
    }
